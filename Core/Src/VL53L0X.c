...
void selectAddress_VL53L0X(uint8_t addr8){
	g_i2cAddr = addr8;
}

void getDistance(uint16_t *dist, statInfo_t_VL53L0X *dist_t, uint8_t addr8){
	selectAddress_VL53L0X(addr8);
	*dist = readRangeSingleMillimeters(dist_t);
